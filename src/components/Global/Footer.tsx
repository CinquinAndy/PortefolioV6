						...
						<div className="flex items-center justify-evenly gap-8 xl:gap-10">
							<div className={'relative p-3'}>
								<Link
									...
									target="_blank"
								>
									<svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-label="Facebook">
							...
							<div className={'relative p-3'}>
								<Link
									...
									target="_blank"
								>
									<svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-label="Github">
										<title>Github</title>
							...
							<div className={'relative p-3'}>
								<Link
									...
									target="_blank"
								>
									<svg className="h-6 w-6" fill="currentColor" viewBox="0 0 1000 1000" aria-label="Malt">
										<title>Malt</title>
										<path
