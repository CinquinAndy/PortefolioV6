						...
						<div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full">
							...
							>
								<Dialog.Panel className="pointer-events-auto relative h-screen w-screen">
									<div className="flex h-full flex-col overflow-y-scroll border-slate-50 border-opacity-10 bg-linear-to-b from-indigo-1100 to-sky-1100 py-6 text-slate-50 shadow-xl md:border-l-40">
