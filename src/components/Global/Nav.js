...
function Nav({ content }) {
	...
	const menu = content.attributes.menu
	return (
		<>
			...
			<nav
				id="nav-block"
				className="pointer-events-none fixed -z-10 flex h-screen w-screen -translate-y-[100vh] transform opacity-0 transition-transform"
			>
				<div className="xl:border-r-40 from-indigo-1100 to-sky-1100 flex h-full w-full flex-col justify-around gap-12 border-r-0 border-slate-50 border-opacity-10 bg-gradient-to-b p-4 pt-28 xl:w-2/5 xl:gap-24 xl:p-20 xl:pt-36">
					{/*// <!--        Si page d'accueil -->*/}
					<Link className="relative text-indigo-400" href="/" rel="noopener">
						<svg
					...
					>
						...
						<svg
							className="absolute left-0 top-1/2 h-10 w-10 -translate-x-[50px] -translate-y-1/2 transform"
							viewBox="0 0 156 156"
							fill="currentColor"
						>
							<path
					...
					<div>
						...
						<div className="flex">
							<div className="flex items-center justify-evenly gap-10">
								...
								<a
									className="text-indigo-500 hover:text-slate-50"
									href="https://www.malt.fr/profile/andycinquin/"
									rel="noopener nofollow noreferrer"
									target="_blank"
								>
									<svg
		...
		C857.8,691,581.3,691.8,581.3,691.8z"
					...
					<div className="flex flex-col text-xs text-slate-300">
						<p className="font-body normal-case">
							72 avenue camus, 44000 Nantes
						</p>
						<a className="font-body mt-2 normal-case" href="tel:+33621582684">
							+33 6 21 58 26 84
						</a>
					</div>
			...
			<div className="relative flex h-screen w-screen items-center justify-center">
				...
				<h1 className="z-20 text-3xl font-light font-semibold uppercase tracking-widest xl:text-8xl">
				...
				<div className="absolute left-1/2 top-1/2 z-10 flex w-3/5 -translate-x-1/2 -translate-y-1/2 transform items-center justify-start">
					<Image
						...
						className="w-112 h-112 mb-32 ml-16 -rotate-12 opacity-20 brightness-75"
					/>
				</div>
				{/*// <!--    MEDIA -->*/}
