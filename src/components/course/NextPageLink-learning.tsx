...
export function NextPageLink({ title, description, href }: { title: string; description: string; href: string }) {
	return (
		<div className="flow-root font-sans">
			<Link
				href={href}
				className="-mx-3 -my-2 block rounded-xl px-4 py-4 border-2 border-indigo-500/20 bg-indigo-950/10 hover:bg-indigo-950/20 hover:border-indigo-400/40 transition-all duration-300 shadow-lg shadow-indigo-500/5"
			>
