...
export interface FancyCardProps extends React.HTMLAttributes<HTMLDivElement>, VariantProps<typeof fancyCardVariants> {}

const FancyCardContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
	({ className, ...props }, ref) => (
...
const FancyCard = React.forwardRef<HTMLDivElement, FancyCardProps>(
	({ className, variant, children, ...props }, ref) => {
		return (
			<div ref={ref} className={cn(fancyCardVariants({ variant, className }))} {...props}>
